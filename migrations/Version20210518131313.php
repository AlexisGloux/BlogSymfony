 ...
 */
final class Version20210518131313 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE IF NOT EXISTS author (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, email VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('INSERT INTO author (name) VALUES (\'inconnu\')');
        $this->addSql('ALTER TABLE post ADD written_by_id INT');
        $this->addSql('UPDATE post SET written_by_id = (SELECT id FROM author WHERE name = \'inconnu\')');
